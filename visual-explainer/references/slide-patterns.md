...
- Warm Signal: "warm cream textured paper with cornflower-blue geometric accents, confident modern design"
...
Cream paper, bold sans, cornflower/teal accents. Confident and modern. Light-first.
...
:root {
  ...
  --border-bright: rgba(20, 40, 60, 0.16);
  --text: #1a2332;
  --text-dim: #6b7b8f;
  --accent: #6495ED;
  --accent-dim: rgba(100, 149, 237, 0.08);
  --code-bg: #1a2332;
  --code-text: #e0e8f0;
}
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --surface: #1a2230;
    --surface2: #222e3e;
    --surface-elevated: #283648;
    --border: rgba(160, 180, 200, 0.08);
    --border-bright: rgba(160, 180, 200, 0.16);
    --text: #e0e8f0;
    --text-dim: #8899aa;
    --accent: #7eaaf0;
    --accent-dim: rgba(126, 170, 240, 0.1);
    --code-bg: #0d1218;
    --code-text: #e0e8f0;
  }
}
...
Background: cool radial glow at bottom left. Cornflower accent borders on cards. Section divider numbers in ultra-light blue.
